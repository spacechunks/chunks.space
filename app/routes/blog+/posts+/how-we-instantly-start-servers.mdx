...
With Chunk Explorer we want to create a platform where everyone can publish their Minecraft creations for others to play or just for you and your friends. You will be able to easily run your own Minecraft server, install the plugins you want, and let others play on your *Chunk*. The Chunk Explorer will be offered as a free service with reasonable limits for each user.
