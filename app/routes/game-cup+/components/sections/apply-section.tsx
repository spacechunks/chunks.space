...
export default function ApplySection() {
  return (
    <Section id="game-cup">
      <div className="relative flex flex-col items-stretch justify-center rounded-lg bg-[#20143C] px-12 py-16 md:flex-row">
        ...
        <div className="hidden h-auto max-w-[18rem] md:absolute md:-bottom-1/2 md:right-5 md:block md:w-1/2 md:-translate-y-1/2">
        ...
        <div className="relative flex flex-col items-center justify-center gap-10 md:w-1/2">
          <TypographyH1 className="text-ethereal-normal text-center">
            Are you talented enough?
          </TypographyH1>
          <div>
            <TypographyLead className="text-ethereal-normal text-center text-2xl">
