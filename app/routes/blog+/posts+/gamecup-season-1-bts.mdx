...
authors:
  ...
  - name: Fllip
    image: https://cravatar.eu/helmavatar/fllip/64
---

# {frontmatter.title}
Our debut season was a thrilling pilot run, but it wasn’t without its hiccups. In this blog post, we’ll dive into the challenges we faced, the feedback we received from participants and the community, and the improvements we’re planning for the second season of the Game Cup.
...
Right after the first season, we began planning for the second season. We want to take the time to thoroughly test everything and revise our structures. The next season of the Game Cup is expected to take place sometime in 2025.
